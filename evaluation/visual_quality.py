...
def main(args):
    ...
    for line in lines:
        ...
        synt = readvideo('{}/{}_g.mp4'.format(args.synt_root, line))
        ...
        for i in range(len_com):
            ...
            synt_re = cv2.resize(synt[i], (96, 96))

            ssim.append(structural_similarity(gt_re, synt_re, channel_axis=2, gaussian_weights=True, sigma=1.5, use_sample_covariance=False, data_range=255))
