...
def synt_demo(face_detector, device, model,emotion_encoder,decoder, args):
    ...
    save_path = os.path.join('/home/star/wy', args.emotion)
    if save_path is not None:
        os.makedirs(save_path, exist_ok=True)
    save_sample_images(inps, prediction, 1000, save_path)
    processed_img = emb_roi2im([idAudio], imgs, bbxs, prediction.cpu(), 'cpu')
    print()

    out_path = '{}_{}.mp4'.format(args.save_path, args.emotion)
    tmpvideo = '{}_{}.avi'.format(args.save_path, args.emotion)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_path', help='pretrained checkpoint', required=True, default='/ssd2/m3lab/usrs/wy/TalkLip/restart/checkpoint_step000148000.pth' ,type=str)
    parser.add_argument('--emotion_encoder_ckpt_path', help='pretrained checkpoint', required=True, default='/ssd2/m3lab/usrs/wy/TalkLip/restart/emoGen_checkpoint_step000148000.pth',type=str)
    parser.add_argument('--decoder_ckpt_path', help='pretrained checkpoint', required=True, default='/ssd2/m3lab/usrs/wy/TalkLip/restart/decoder_checkpoint_step000148000.pth',type=str)
    ...
    load_checkpoint('/home/star/wy/emo_disc_ checkpoint/emo_disccheckpoint_step000062000.pth', emoDisc, emo_dis_optimizer ,
