...
parser.add_argument(
    "--device", type=str, default=3, help="Device to use. Like cuda, cuda:0 or cpu"
)
parser.add_argument(
    "--dims",
    type=int,
...
def main():
    ...
    dir1 = "/ssd2/m3lab/usrs/wy/TalkLip/frames2"
    dir2 = "/ssd2/m3lab/usrs/wy/TalkLip/frame"
